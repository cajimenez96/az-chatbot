  ...
  return (
    <div style={{ maxWidth: '800px' }}>
      ...
      <div style={{ 
        ...
        {isLoading && (
          <div style={{ color: 'white' }}>Cargando estado...</div>
        )}

        {isError && (
          <div style={{ color: '#ff4444', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        {data?.isConnected ? (
          <div style={{ 
            ...
            <CheckCircle2 size={60} color="#00ff64" style={{ marginBottom: 'var(--space-md)' }} />
            <h2 style={{ color: 'white', font: 'var(--text-heading-sm)', marginBottom: '8px' }}>
              BOT CONECTADO
            </h2>
          ...
          <>
            {data?.qrCode ? (
              ...
              <div style={{ 
                ...
                <RefreshCcw size={40} className="animate-spin" color="var(--color-primary)" style={{ marginBottom: 'var(--space-md)' }} />
                <p style={{ color: 'white' }}>Esperando código QR del Bot...</p>
                <p style={{ color: 'var(--color-ash)', fontSize: '14px' }}>
                  Asegurate de que el proceso del Bot esté corriendo en tu servidor.
                </p>
              </div>
            )}

            <div style={{ marginTop: 'var(--space-lg)' }}>
              <h3 style={{ color: 'white', font: 'var(--text-body-lg)', marginBottom: 'var(--space-md)' }}>
                Instrucciones de vinculación:
              </h3>
              <ol style={{ textAlign: 'left', color: 'var(--color-ash)', lineHeight: '1.6' }}>
